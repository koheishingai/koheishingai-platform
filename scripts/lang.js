...
(function(){
  ...
  setLang = function(){
    _lang = getLang();
    $head.append('<link class="langstyle" rel="stylesheet" href="https://rawgithub.com/koheishingai/koheishingai-platform/master/styles/main'+_lang+'.css?'+getTime()+'" type="text/css">');
    if(_lang === 'ja'){
      $html.attr("lang", "ja");
